...
#.split("&")[1].split("=")[1]
  ...
  def update
    respond_to do |format|
      if @course.update(course_params)
        format.html { redirect_to admins_course_path, notice: 'Course was successfully updated.' }
  ...
  def destroy
    @course.destroy
    respond_to do |format|
      format.html { redirect_to admins_courses_path, notice: 'Course was successfully destroyed.' }
